...
const Events = () => {
  ...
  <h2 class="text-4xl sm:text-5xl md:text-4xl text-center chelsea-market-regular font-bold text-[#6b2c86] md:mb-16 mb-10">Our Events </h2>

  <div class="px-4 md:px-[2rem] xl:px-[6rem] flex flex-col lg:flex-row gap-10">
 
    <div class="lg:w-[80%] xl:w-[60%]">
 
      <img class="w-full object-cover h-[12rem] md:h-[18rem] aspect-square" src="https://techakim.com/sam/tg/7268/li/imgs/bg-blog.png" alt="blog image"/>

      <div class="flex flex-col px-6 py-8 border-l border-r border-b">
        
        
     
        <h3 class="text-2xl md:text-3xl font-semibold text-teal-900 chelsea-market-regular">A Beginner's Guide to Modern Web Design</h3>
      
        <p class="text-md text-gray-500">Step into the world of Tailwind CSS with this beginner-friendly guide. Learn
          the basics of Tailwind's utility classes, responsive design features, and customization options to kickstart
          your journey in modern web design.</p>
      </div>
    </div>
    ...
    <div class="w-full flex flex-col items-stretch justify-center">
      ...
      <div class="flex flex-col sm:flex-row gap-6 pb-6 border-b-2 border-gray-100">
        ...
        <div class="flex flex-col justify-between">
          ...
          {/* <!-- Blog Titile --> */}
          <h3 class="text-2xl md:text-3xl font-semibold text-teal-900 capitalize chelsea-market-regular">Tailwind CSS Pro Tips: Advanced Techniques for
            Stunning Web Interfaces</h3>
          {/* <!-- Blog Description --> */}
          <p class="text-md text-gray-500">Elevate your web design skills with advanced tips and tricks for Tailwind
            CSS. Uncover techniques for optimizing your workflow</p>
        </div>
      </div>
      ...
      <div class="flex flex-col sm:flex-row gap-6 pb-6 border-b-2 border-gray-100">
        ...
        <div class="flex flex-col justify-between">
          ...
          {/* <!-- Blog Titile -->/ */}
          <h3 class="text-2xl md:text-3xl font-semibold text-teal-900 capitalize chelsea-market-regular">Responsive Design Made Easy: Harnessing Tailwind
            CSS for Mobile-First Websites</h3>
          {/* <!-- Blog Description -->/ */}
          <p class="text-md text-gray-500">Explore how Tailwind CSS simplifies responsive design for mobile-first
            websites.</p>
        </div>
      </div>
