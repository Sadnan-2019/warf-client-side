          ...
          <div class=" p-4 min-h-screen">
            <div class="max-w-7xl mx-auto h-max px-6 md:px-12 xl:px-6 ">
              <div class="md:w-2/3 lg:w-1/2">
                ...
                <h2 class="my-8 text-2xl font-bold text-[#6b2c86] md:text-4xl">
                  The WARF Competitions
                </h2>
                ...
                <div class=" whyone   text-white    relative   transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10  bg-gradient-to-r from-[#341850] via-[#13011b] to-[#38235D]">
                  <div class="relative space-y-8 py-12 p-8">
                    ...
                    <div class="space-y-2">
                      ...
                      <p class="text-white">
                        Our mission is not just to build robots but to empower
                        humanity with the tools to achieve a brighter and more
                        equitable future.
                      </p>
                    </div>
                  </div>
                ...
                <div class="group relative  transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10  bg-gradient-to-r from-[#341850] via-[#13011b] to-[#38235D]">
                  <div class="relative space-y-8 py-12 p-8">
                    ...
                    <div class="space-y-2">
                      ...
                      <p class="text-gray-300">
                          Robo Sports, we envision a future where robotics
                        becomes an integral part of global sports
                        culture—fueling technological innovation, inspiring
                        creativity, and uniting people through the excitement of
                        competition.
                      </p>
                    </div>
                  </div>
                ...
                <div class="whyone   group relative  transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10  bg-gradient-to-r from-[#341850] via-[#13011b] to-[#38235D]">
                  <div class="relative space-y-8 py-12 p-8">
                    ...
                    <div class="space-y-2">
                      ...
                      <p class="text-white">
                          Future Innovators, we envision a world where
                        every child has the opportunity to explore their
                        potential, contribute to technological progress, and
                        lead transformative change in society.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="group relative   transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10  bg-gradient-to-r from-[#341850] via-[#13011b] to-[#38235D]">
                  <div class="relative space-y-8 py-12 p-8">
                    ...
                    <div class="space-y-2">
                      ...
                      <p class="text-gray-300">
                        We envision a world where young minds are empowered to
                        design and build sustainable, inclusive, and
                        groundbreaking solutions that elevate society and
                        protect our planet.
                      </p>
                    </div>
                  </div>
